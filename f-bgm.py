...
argument_group_other.add_argument("--download",action="store_true",help="Download neccessary model parameters and external files after initial installation. Default: disabled")
